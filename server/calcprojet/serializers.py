...
# Write serializers for the other models


class NeedRessourceSerializer(serializers.ModelSerializer):
    class Meta:
        model = NeedRessource
        fields = '__all__'
        # fields = ['id', 'name', 'description', 'created_at', 'created_by_email']
...
class NeedValueSerializer(serializers.ModelSerializer):
    class Meta:
        model = NeedValue
        fields = '__all__'
        # fields = ['id', 'name', 'description', 'created_at', 'created_by_email']
...
class MaterialCustomFieldSerializer(serializers.ModelSerializer):
    class Meta:
        model = MaterialCustomField
        fields = '__all__'
        # fields = ['id', 'name', 'description', 'created_at', 'created_by_email']


class MaterialCustomFieldValueSerializer(serializers.ModelSerializer):
    class Meta:
        model = MaterialCustomFieldValue
        fields = '__all__'
        # fields = ['id', 'name', 'description', 'created_at', 'created_by_email']
